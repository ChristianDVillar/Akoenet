/**
 * Comprueba que TAG (p. ej. v0.7.2 desde GitHub Actions) coincide con
 * package.json, src-tauri/tauri.conf.json y src-tauri/Cargo.toml.
 * Uso: TAG=v0.7.2 node scripts/verify-tauri-release-version.mjs
 */
...
if (!tag) {
  console.error('Missing env TAG (e.g. v0.7.2)')
  process.exit(1)
}
